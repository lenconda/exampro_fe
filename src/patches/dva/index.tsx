...
import { AnyAction, bindActionCreators, Dispatch, Middleware } from 'redux';
...
export default function(opts: DvaOption = {} as DvaOption) {
  const history = opts.history as History<object> || createHashHistory();
  const createOpts = {
    initialReducer: {
      router: connectRouter(history),
    },
    setupMiddlewares(middlewares: Middleware<{}, any, Dispatch<AnyAction>>[]) {
